...
def parse_args():
    ...
    integrate_parser.add_argument('--method', '-m', type=str, default='cellhint_prior', choices=['scExtract', 'scanorama_prior', 'cellhint_prior', 'cellhint'], help='Method to use for integration. Support scExtract, scanorama_prior, cellhint_prior and cellhint.')
    ...
    integrate_parser.add_argument('--prior_weight', '-w', type=float, default=0.1, help='Weight of the prior similarity matrix from automatic annotation.')
